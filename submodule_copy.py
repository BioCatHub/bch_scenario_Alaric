...
class importer:
    ...
    def build_data_frame(self):
        ...
        sample_measurements = measurements["samples"]

        for i in reference_measurements:
            data_frame_dict["reference_" + str(reference_measurements.index(i))] = i
        
        for i in sample_measurements:
            data_frame_dict["sample_" + str(sample_measurements.index(i))] = i
    ...
    def measurement_data_to_df(self, bch_model):
        ...
        #print("number of replicates", number_of_replicates)
        ...
        for i in measurement_data:
            ...
            for n in range(number_of_replicates):
                ...
                #y_values[i["notes"]+str(count)] = y_container[n]
                y_values[i["notes"]] = y_container
