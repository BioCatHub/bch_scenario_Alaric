...
class importer:
    ...
    def build_data_frame(self):
        ...
        for i in self.paths:
            bch_model = self.import_enzymeml(i)
    ...
    def measurement_data_to_df(self, bch_model):
        ...
        for i in measurement_data:
            ...
            for n in range(length_of_replicates):
                y_values[measurement_note+reagent_name + "_" + str(n)] = y_container[n]

        return y_values


pay = importer(
    "2022-10-3Metaraminol production using cv20205_20mL_1(noEnzymeML).omex"
).build_data_frame()
print(pay)
